        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              ...
              _buildLegendItem('KEL. RANDUSARI', Colors.green),
              _buildLegendItem('KEL. PETAHUNAN', Colors.orange),
              _buildLegendItem('KEL. KRAPYAKREJO', Colors.purple),
              _buildLegendItem('RW 01-08', Colors.grey),
            ],
          ),
        ],
      ),
